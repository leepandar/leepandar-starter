...
import com.leepandar.starter.data.autoconfigure.idgenerator.MyBatisPlusIdGeneratorConfiguration;
import com.leepandar.starter.data.handler.CompositeBaseEnumTypeHandler;
...
public class MybatisPlusAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("Auto Configuration 'MyBatis Plus' completed initialization.");
    }
}

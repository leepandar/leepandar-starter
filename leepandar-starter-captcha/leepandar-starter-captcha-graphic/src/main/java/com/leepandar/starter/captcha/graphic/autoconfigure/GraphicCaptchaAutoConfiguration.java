package com.leepandar.starter.captcha.graphic.autoconfigure;
...
import com.leepandar.starter.captcha.graphic.core.GraphicCaptchaService;
...
public class GraphicCaptchaAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("Auto Configuration 'Captcha-Graphic' completed initialization.");
    }
}

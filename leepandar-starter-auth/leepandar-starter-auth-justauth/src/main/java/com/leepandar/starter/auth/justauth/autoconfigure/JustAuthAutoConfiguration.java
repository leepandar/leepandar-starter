package com.leepandar.starter.auth.justauth.autoconfigure;
...
import com.leepandar.starter.auth.justauth.core.AuthStateCacheRedisDefaultImpl;
...
public class JustAuthAutoConfiguration {
    ...
    public AuthStateCache authStateCache() {
        ...
        log.debug("Auto Configuration 'JustAuth-AuthStateCache-Redis' completed initialization.");
        return impl;
    }

    @PostConstruct
    public void postConstruct() {
        log.debug("Auto Configuration 'JustAuth' completed initialization.");
    }
}
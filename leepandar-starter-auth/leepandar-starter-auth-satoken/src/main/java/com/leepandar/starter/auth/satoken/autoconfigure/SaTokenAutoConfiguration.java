package com.leepandar.starter.auth.satoken.autoconfigure;
...
import com.leepandar.starter.auth.satoken.autoconfigure.dao.SaTokenDaoConfiguration;
...
public class SaTokenAutoConfiguration implements WebMvcConfigurer {
    ...
    public void postConstruct() {
        log.debug("Auto Configuration 'SaToken' completed initialization.");
    }
}
